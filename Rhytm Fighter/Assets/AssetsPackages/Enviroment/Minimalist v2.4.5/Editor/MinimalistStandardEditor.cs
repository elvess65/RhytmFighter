...
namespace Minimalist
{
    ...
    public class MinimalistStandardEditor : ShaderGUI
    {
        ...
        private void OtherSettings()
        {
            ...
            {
                targetMat.DisableKeyword("USERIM");
            }

            if (!targetMat.name.Contains("LWRP"))
            {
            ...
            targetMat.enableInstancing = EditorGUILayout.Toggle("GPU Instancing", targetMat.enableInstancing);
        ...
        private void FogModule()
        {
            ...
            {
                targetMat.DisableKeyword("HEIGHT_FOG");
            }
        }
        ...
        private void ColorCorrectionModule()
        {
            ...
            {
                targetMat.DisableKeyword("COLORCORRECTION_ON");
            }
        }
        ...
        private void AlignCameraToSelectedObject(string ShadingSide)
        {
            ...
            previousCameraRotation = sc.rotation;
            sc.orthographic = true;

            if (gSpace == GradientSpace.LocalSpace)
            {
                previousObjectRotation = selectedObject.rotation;
                selectedObject.rotation = Quaternion.Euler(Vector3.zero);
            }
        ...
        private void ResetCamera()
        {
            ...
            sc.rotation = previousCameraRotation;
            sc.orthographic = true;
            if (gSpace == GradientSpace.LocalSpace)
            {
                selectedObject.rotation = previousObjectRotation;
            }
        }
