...
namespace RhytmFighter.Objects.Model
{
    ...
    {
        public StandardEnemyNPCModel(int id, GridCellData correspondingCell, float moveSpeed, iBattleActionBehaviour actionBehaviour, iHealthBehaviour healthBehaviour) : 
