...
namespace RhytmFighter.CameraSystem
{
    public class CameraController : iUpdatable
    {
        ...
        private readonly Vector3 m_DEFAULT_CAMERA_TARGET_OFFSET = new Vector3(0, 2.5f, 8);
        ...
        public void AlignDefaultCameraToTarget()
        {
            m_Cameras[CameraTypes.Default].transform.position = m_Target.position + m_DEFAULT_CAMERA_TARGET_OFFSET;
        }
